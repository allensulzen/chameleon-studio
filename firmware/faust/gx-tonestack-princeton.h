...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackPrinceton -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackPrinceton_H__
#define  __GxTonestackPrinceton_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackPrinceton
#endif
...
static double GxTonestackPrinceton_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackPrinceton_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackPrinceton : public chdsp {
 ...
 public:
	GxTonestackPrinceton() {
	}
	
	GxTonestackPrinceton(const GxTonestackPrinceton&) = default;
	
	virtual ~GxTonestackPrinceton() = default;
	
	GxTonestackPrinceton& operator=(const GxTonestackPrinceton&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackPrinceton -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-princeton.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackPrinceton_faustpower2_f(fConst0);
		fConst2 = GxTonestackPrinceton_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackPrinceton* clone() {
		return new GxTonestackPrinceton(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = 1.0855872000000003e-07 * fSlow1;
		double fSlow3 = fConst1 * (fSlow1 * (5.6541000000000015e-06 * fSlow0 + -2.1333412800000006e-06 - fSlow2) + 0.00011998125000000002 * fSlow0 + 3.222390000000001e-06);
		double fSlow4 = 7.343750000000001e-09 * fSlow0;
		double fSlow5 = 4.935e-10 * fSlow0 - 9.4752e-12 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -1.315248e-10) + fSlow4 + 1.41e-10);
		double fSlow7 = 0.0250625 * fSlow0;
		double fSlow8 = 0.0002256 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.015243699999999999);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 9.4752e-12) + fSlow15 * (fSlow4 + 1.41e-10 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (9.187500000000001e-07 * fSlow15 + fSlow1 * (1.2265872000000003e-07 - fSlow2) + fSlow0 * (5.6541000000000015e-06 * fSlow1 + 2.48125e-06) + 4.764000000000001e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 6.25e-05 * fSlow15 + 0.00048120000000000004);
