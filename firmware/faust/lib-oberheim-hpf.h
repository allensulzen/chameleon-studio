...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn LibOberheimHpf -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __LibOberheimHpf_H__
#define  __LibOberheimHpf_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS LibOberheimHpf
#endif
...
static float LibOberheimHpf_faustpower2_f(float value) {
	return value * value;
}

class LibOberheimHpf : public chdsp {
 ...
 public:
	...
	LibOberheimHpf(const LibOberheimHpf&) = default;
	
	virtual ~LibOberheimHpf() = default;
	
	LibOberheimHpf& operator=(const LibOberheimHpf&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn LibOberheimHpf -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("description", "Oberheim SEM state-variable highpass - resonant thinning and telephone tones");
		m->declare("family", "filter");
		m->declare("filename", "lib-oberheim-hpf.dsp");
		...
		m->declare("name", "Oberheim SEM HPF");
		m->declare("platform.lib/name", "Generic Platform Library");
		m->declare("platform.lib/version", "1.3.0");
		m->declare("signals.lib/name", "Faust Routing Library");
		m->declare("signals.lib/version", "1.7.0");
		m->declare("source", "grame-cncm/faustlibraries/vaeffects.lib ve.oberheimHPF");
		...
		m->declare("vaeffects.lib/oberheimHPF:license", "LicenseRef-STK-4.3");
	...
	virtual LibOberheimHpf* clone() {
		return new LibOberheimHpf(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Oberheim SEM HPF");
		ui_interface->declare(&fHslider1, "0", "");
		ui_interface->declare(&fHslider1, "scale", "log");
		ui_interface->declare(&fHslider1, "unit", "Hz");
		ui_interface->addHorizontalSlider("Cutoff", &fHslider1, FAUSTFLOAT(4e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(8e+03f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = faust_wrap_add(i0, 1)) {
			...
			float fRec1 = fTemp4;
			float fTemp5 = fTemp0 * fTemp3 / fTemp2;
			float fTemp6 = std::max<float>(-1.0f, std::min<float>(1.0f, fRec3[1] + fTemp5));
			float fTemp7 = 1.0f - 0.33333334f * LibOberheimHpf_faustpower2_f(fTemp6);
			float fTemp8 = fTemp0 * fTemp6 * fTemp7;
			fRec2[0] = fRec2[1] + 2.0f * fTemp8;
			float fTemp9 = fTemp6 * fTemp7;
			fRec3[0] = fTemp5 + fTemp9;
