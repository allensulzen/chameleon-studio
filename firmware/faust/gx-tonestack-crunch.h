...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackCrunch -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackCrunch_H__
#define  __GxTonestackCrunch_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackCrunch
#endif
...
static double GxTonestackCrunch_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackCrunch_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackCrunch : public chdsp {
 ...
 public:
	...
	GxTonestackCrunch(const GxTonestackCrunch&) = default;
	
	virtual ~GxTonestackCrunch() = default;
	
	GxTonestackCrunch& operator=(const GxTonestackCrunch&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackCrunch -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-crunch.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackCrunch_faustpower2_f(fConst0);
		fConst2 = GxTonestackCrunch_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackCrunch* clone() {
		return new GxTonestackCrunch(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Hughes&Kettner");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow3 = fConst1 * (fSlow1 * (4.882548000000001e-06 * fSlow0 + -1.964318e-06 - fSlow2) + 4.9553415999999996e-05 * fSlow0 + 2.7073879999999998e-06);
		double fSlow4 = 2.3521432000000003e-09 * fSlow0;
		double fSlow5 = 3.4212992000000004e-10 * fSlow0 - 1.5551360000000004e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -9.136424e-11) + fSlow4 + 1.0691560000000001e-10);
		double fSlow7 = 0.0103884 * fSlow0;
		double fSlow8 = 0.00047000000000000004 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.009920600000000002);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 1.5551360000000004e-11) + fSlow15 * (fSlow4 + 1.0691560000000001e-10 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (4.5496e-07 * fSlow15 + fSlow1 * (2.4468200000000005e-07 - fSlow2) + fSlow0 * (4.882548000000001e-06 * fSlow1 + 9.55416e-07) + 4.3428e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 4.84e-05 * fSlow15 + 0.00047220000000000004);
