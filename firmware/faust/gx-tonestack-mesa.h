...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackMesa -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackMesa_H__
#define  __GxTonestackMesa_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackMesa
#endif
...
static double GxTonestackMesa_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackMesa_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackMesa : public chdsp {
 ...
 public:
	...
	GxTonestackMesa(const GxTonestackMesa&) = default;
	
	virtual ~GxTonestackMesa() = default;
	
	GxTonestackMesa& operator=(const GxTonestackMesa&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackMesa -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-mesa.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackMesa_faustpower2_f(fConst0);
		fConst2 = GxTonestackMesa_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackMesa* clone() {
		return new GxTonestackMesa(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Mesa Boogie");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow16 = fSlow1 * (fSlow5 + 2.5703125000000003e-10) + fSlow15 * (fSlow4 + 7.343750000000001e-10 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (9.187500000000001e-07 * fSlow15 + fSlow1 * (3.0182812500000004e-06 - fSlow2) + fSlow0 * (2.9448437500000007e-05 * fSlow1 + 2.48125e-06) + 2.48125e-07);
