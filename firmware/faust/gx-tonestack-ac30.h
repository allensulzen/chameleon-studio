...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackAc30 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackAc30_H__
#define  __GxTonestackAc30_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackAc30
#endif
...
static double GxTonestackAc30_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackAc30_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackAc30 : public chdsp {
 ...
 public:
	...
	GxTonestackAc30(const GxTonestackAc30&) = default;
	
	virtual ~GxTonestackAc30() = default;
	
	GxTonestackAc30& operator=(const GxTonestackAc30&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackAc30 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-ac30.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackAc30_faustpower2_f(fConst0);
		fConst2 = GxTonestackAc30_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackAc30* clone() {
		return new GxTonestackAc30(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = 4.851e-08 * fSlow1;
		double fSlow3 = fConst1 * (fSlow1 * (4.8510000000000015e-06 * fSlow0 + -4.2449000000000006e-07 - fSlow2) + 4.972000000000001e-05 * fSlow0 + 7.172000000000001e-07);
		double fSlow4 = 2.4200000000000003e-09 * fSlow0;
		double fSlow5 = 2.6620000000000007e-10 * fSlow0 - 2.662e-12 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -2.1538000000000003e-11) + fSlow4 + 2.4200000000000004e-11);
		double fSlow7 = 0.022050000000000004 * fSlow0;
		double fSlow8 = 0.00022 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.0046705);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 2.662e-12) + fSlow15 * (fSlow4 + 2.4200000000000004e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (2.2000000000000004e-07 * fSlow15 + fSlow1 * (5.951000000000001e-08 - fSlow2) + fSlow0 * (4.8510000000000015e-06 * fSlow1 + 1.32e-06) + 1.32e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 5e-05 * fSlow15 + 0.00022050000000000002);
