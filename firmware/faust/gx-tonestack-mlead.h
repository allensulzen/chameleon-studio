...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackMlead -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackMlead_H__
#define  __GxTonestackMlead_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackMlead
#endif
...
static double GxTonestackMlead_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackMlead_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackMlead : public chdsp {
 ...
 public:
	...
	GxTonestackMlead(const GxTonestackMlead&) = default;
	
	virtual ~GxTonestackMlead() = default;
	
	GxTonestackMlead& operator=(const GxTonestackMlead&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackMlead -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-mlead.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackMlead_faustpower2_f(fConst0);
		fConst2 = GxTonestackMlead_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackMlead* clone() {
		return new GxTonestackMlead(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow3 = fConst1 * (fSlow1 * (1.2375000000000003e-05 * fSlow0 + -2.1175000000000003e-08 - fSlow2) + 1.9448000000000004e-05 * fSlow0 + 6.677000000000001e-07);
		double fSlow4 = 1.9965000000000003e-09 * fSlow0;
		double fSlow5 = 1.7121500000000001e-09 * fSlow0 - 4.2803750000000003e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -7.108750000000004e-12) + fSlow4 + 4.991250000000001e-11);
		double fSlow7 = 0.022500000000000003 * fSlow0;
		double fSlow8 = 0.00055 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.0021395000000000003);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 4.2803750000000003e-11) + fSlow15 * (fSlow4 + 4.991250000000001e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (1.815e-07 * fSlow15 + fSlow1 * (3.781250000000001e-07 - fSlow2) + fSlow0 * (1.2375000000000003e-05 * fSlow1 + 3.4760000000000007e-06) + 8.690000000000002e-08);
