...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackBassman -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackBassman_H__
#define  __GxTonestackBassman_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackBassman
#endif
...
static double GxTonestackBassman_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackBassman_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackBassman : public chdsp {
 ...
 public:
	...
	GxTonestackBassman(const GxTonestackBassman&) = default;
	
	virtual ~GxTonestackBassman() = default;
	
	GxTonestackBassman& operator=(const GxTonestackBassman&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackBassman -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-bassman.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackBassman_faustpower2_f(fConst0);
		fConst2 = GxTonestackBassman_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackBassman* clone() {
		return new GxTonestackBassman(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = 2.5312500000000006e-07 * fSlow1;
		double fSlow3 = fConst1 * (fSlow1 * (1.0125e-05 * fSlow0 + -2.75625e-07 - fSlow2) + 2.4210000000000004e-05 * fSlow0 + 7.4525e-07);
		double fSlow4 = 1.4000000000000001e-09 * fSlow0;
		double fSlow5 = 7.650000000000002e-10 * fSlow0 - 1.9125000000000002e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -1.5875000000000007e-11) + fSlow4 + 3.500000000000001e-11);
		double fSlow7 = 0.02025 * fSlow0;
		double fSlow8 = 0.0005 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.0028087500000000005);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 1.9125000000000002e-11) + fSlow15 * (fSlow4 + 3.500000000000001e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (1.4e-07 * fSlow15 + fSlow1 * (2.8437500000000003e-07 - fSlow2) + fSlow0 * (1.0125e-05 * fSlow1 + 1.8100000000000002e-06) + 4.525e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 6.25e-05 * fSlow15 + 0.00050625);
