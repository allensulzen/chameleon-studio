...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn TdgDuckReverb -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __TdgDuckReverb_H__
#define  __TdgDuckReverb_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS TdgDuckReverb
#endif
...
class TdgDuckReverb : public chdsp {
 ...
 public:
	...
	TdgDuckReverb(const TdgDuckReverb&) = default;
	
	virtual ~TdgDuckReverb() = default;
	
	TdgDuckReverb& operator=(const TdgDuckReverb&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn TdgDuckReverb -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "1.2.0");
		m->declare("description", "Freeverb ducked by an envelope follower: the tail stays out of the way while you play and blooms in the gaps");
		m->declare("family", "reverb");
		m->declare("filename", "tdg-duck-reverb.dsp");
		...
		m->declare("source", "thedrgreenthumb/faust duck_reverb.dsp + freeverb.dspi");
	}
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst3 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.025306122f * fConst0), 22));
		iConst4 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.026938776f * fConst0), 22));
		iConst5 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.028956916f * fConst0), 22));
		iConst6 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.030748298f * fConst0), 22));
		iConst7 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.0322449f * fConst0), 22));
		iConst8 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.033809524f * fConst0), 22));
		iConst9 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.035306122f * fConst0), 22));
		iConst10 = std::max<int>(0, faust_wrap_add(static_cast<int>(0.036666665f * fConst0), 22));
		iConst11 = std::min<int>(1024, std::max<int>(0, faust_wrap_add(static_cast<int>(0.0126077095f * fConst0), 22)));
		iConst12 = std::min<int>(1024, std::max<int>(0, faust_wrap_add(static_cast<int>(0.01f * fConst0), 22)));
		iConst13 = std::min<int>(1024, std::max<int>(0, faust_wrap_add(static_cast<int>(0.0077324263f * fConst0), 22)));
		iConst14 = std::min<int>(1024, std::max<int>(0, faust_wrap_add(static_cast<int>(0.0051020407f * fConst0), 22)));
		fConst15 = std::exp(-(5e+01f / fConst0));
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider4 = static_cast<FAUSTFLOAT>(18.0f);
	...
	virtual TdgDuckReverb* clone() {
		return new TdgDuckReverb(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Duck Reverb");
		ui_interface->declare(&fHslider2, "0", "");
		ui_interface->declare(&fHslider2, "unit", "s");
		ui_interface->addHorizontalSlider("Attack", &fHslider2, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.05f), FAUSTFLOAT(0.5f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider3, "1", "");
		ui_interface->declare(&fHslider3, "unit", "s");
		ui_interface->addHorizontalSlider("Release", &fHslider3, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.05f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider4, "2", "");
		ui_interface->declare(&fHslider4, "unit", "dB");
		ui_interface->addHorizontalSlider("Duck Amount", &fHslider4, FAUSTFLOAT(18.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(4e+01f), FAUSTFLOAT(0.5f));
		...
		ui_interface->addHorizontalSlider("Damp", &fHslider1, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider5, "5", "");
		ui_interface->addHorizontalSlider("Wet/Dry", &fHslider5, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow4 = ((iSlow3) ? 0.0f : std::exp(-(fConst16 / ((iSlow3) ? 1.0f : fSlow2))));
		float fSlow5 = 1.0f - fSlow4;
		float fSlow6 = static_cast<float>(fHslider3);
		int iSlow7 = std::fabs(fSlow6) < 1.1920929e-07f;
		float fSlow8 = ((iSlow7) ? 0.0f : std::exp(-(fConst16 / ((iSlow7) ? 1.0f : fSlow6))));
		float fSlow9 = 1.0f - fSlow8;
		float fSlow10 = fConst1 * static_cast<float>(fHslider4);
		float fSlow11 = fConst1 * static_cast<float>(fHslider5);
		for (int i0 = 0; i0 < count; i0 = faust_wrap_add(i0, 1)) {
			...
			fRec28[0] = std::max<float>(fTemp7, fRec28[1] * fSlow8 + fTemp7 * fSlow9);
			fRec27[0] = fRec28[0] * fSlow5 + fSlow4 * fRec27[1];
			fRec29[0] = fSlow10 + fConst2 * fRec29[1];
			fRec26[0] = fConst17 * std::pow(1e+01f, -(0.05f * fRec29[0] * std::min<float>(1.0f, 4.0f * fRec27[0]))) + fConst15 * fRec26[1];
			fRec30[0] = fSlow11 + fConst2 * fRec30[1];
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp2 * (1.0f - fRec30[0]) + 0.045f * fRec30[0] * fRec26[0] * (fRec1 + fRec0[1]));
			fRec9[1] = fRec9[0];
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
