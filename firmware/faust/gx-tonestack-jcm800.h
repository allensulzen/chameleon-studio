...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackJcm800 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackJcm800_H__
#define  __GxTonestackJcm800_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackJcm800
#endif
...
static double GxTonestackJcm800_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackJcm800_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackJcm800 : public chdsp {
 ...
 public:
	...
	GxTonestackJcm800(const GxTonestackJcm800&) = default;
	
	virtual ~GxTonestackJcm800() = default;
	
	GxTonestackJcm800& operator=(const GxTonestackJcm800&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackJcm800 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-jcm800.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackJcm800_faustpower2_f(fConst0);
		fConst2 = GxTonestackJcm800_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackJcm800* clone() {
		return new GxTonestackJcm800(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("JCM-800");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow16 = fSlow1 * (fSlow5 + 2.7855380960000008e-11) + fSlow15 * (fSlow4 + 3.6333105600000014e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (1.5013680000000003e-07 * fSlow15 + fSlow1 * (2.893061600000001e-07 - fSlow2) + fSlow0 * (1.0875480000000001e-05 * fSlow1 + 2.95724e-06) + 6.505928000000001e-08);
