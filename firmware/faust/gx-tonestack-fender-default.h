...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackFenderDefault -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackFenderDefault_H__
#define  __GxTonestackFenderDefault_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackFenderDefault
#endif
...
static double GxTonestackFenderDefault_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackFenderDefault_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackFenderDefault : public chdsp {
 ...
 public:
	GxTonestackFenderDefault() {
	}
	
	GxTonestackFenderDefault(const GxTonestackFenderDefault&) = default;
	
	virtual ~GxTonestackFenderDefault() = default;
	
	GxTonestackFenderDefault& operator=(const GxTonestackFenderDefault&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackFenderDefault -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-fender-default.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackFenderDefault_faustpower2_f(fConst0);
		fConst2 = GxTonestackFenderDefault_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackFenderDefault* clone() {
		return new GxTonestackFenderDefault(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Fender");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow16 = fSlow1 * (fSlow5 + 4.1125e-11) + fSlow15 * (fSlow4 + 2.9375e-10 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (9.187500000000001e-07 * fSlow15 + fSlow1 * (5.0055e-07 - fSlow2) + fSlow0 * (1.1779375000000001e-05 * fSlow1 + 2.48125e-06) + 9.925e-08);
