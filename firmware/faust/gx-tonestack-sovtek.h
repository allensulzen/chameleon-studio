...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackSovtek -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackSovtek_H__
#define  __GxTonestackSovtek_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackSovtek
#endif
...
static double GxTonestackSovtek_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackSovtek_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackSovtek : public chdsp {
 ...
 public:
	...
	GxTonestackSovtek(const GxTonestackSovtek&) = default;
	
	virtual ~GxTonestackSovtek() = default;
	
	GxTonestackSovtek& operator=(const GxTonestackSovtek&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackSovtek -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-sovtek.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackSovtek_faustpower2_f(fConst0);
		fConst2 = GxTonestackSovtek_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackSovtek* clone() {
		return new GxTonestackSovtek(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow16 = fSlow1 * (fSlow5 + 1.2443156000000002e-11) + fSlow15 * (fSlow4 + 5.345780000000001e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (4.859800000000001e-07 * fSlow15 + fSlow1 * (1.0113400000000001e-07 - fSlow2) + fSlow0 * (4.943400000000001e-06 * fSlow1 + 6.141960000000001e-06) + 6.141960000000001e-08);
