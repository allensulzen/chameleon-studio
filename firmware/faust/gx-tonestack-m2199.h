...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackM2199 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackM2199_H__
#define  __GxTonestackM2199_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackM2199
#endif
...
static double GxTonestackM2199_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackM2199_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackM2199 : public chdsp {
 ...
 public:
	...
	GxTonestackM2199(const GxTonestackM2199&) = default;
	
	virtual ~GxTonestackM2199() = default;
	
	GxTonestackM2199& operator=(const GxTonestackM2199&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackM2199 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-m2199.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackM2199_faustpower2_f(fConst0);
		fConst2 = GxTonestackM2199_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackM2199* clone() {
		return new GxTonestackM2199(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("M2199");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow16 = fSlow1 * (fSlow5 + 1.0561781250000003e-10) + fSlow15 * (fSlow4 + 1.9328750000000007e-10 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (3.2900000000000005e-07 * fSlow15 + fSlow1 * (1.4614062500000001e-06 - fSlow2) + fSlow0 * (1.38796875e-05 * fSlow1 + 1.0633750000000002e-06) + 1.0633750000000002e-07);
