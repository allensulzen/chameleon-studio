...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackTwin -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackTwin_H__
#define  __GxTonestackTwin_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackTwin
#endif
...
static double GxTonestackTwin_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackTwin_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackTwin : public chdsp {
 ...
 public:
	...
	GxTonestackTwin(const GxTonestackTwin&) = default;
	
	virtual ~GxTonestackTwin() = default;
	
	GxTonestackTwin& operator=(const GxTonestackTwin&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackTwin -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-twin.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackTwin_faustpower2_f(fConst0);
		fConst2 = GxTonestackTwin_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackTwin* clone() {
		return new GxTonestackTwin(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow3 = fConst1 * (fSlow1 * (1.1764100000000001e-05 * fSlow0 + -4.215336e-06 - fSlow2) + 0.00011869100000000002 * fSlow0 + 5.188640000000001e-06);
		double fSlow4 = 3.525e-09 * fSlow0;
		double fSlow5 = 4.935e-10 * fSlow0 - 1.974e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -1.2126e-10) + fSlow4 + 1.41e-10);
		double fSlow7 = 0.02503 * fSlow0;
		double fSlow8 = 0.00047000000000000004 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.0157312);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 1.974e-11) + fSlow15 * (fSlow4 + 1.41e-10 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (4.410000000000001e-07 * fSlow15 + fSlow1 * (4.846640000000001e-07 - fSlow2) + fSlow0 * (1.1764100000000001e-05 * fSlow1 + 1.1910000000000001e-06) + 4.764000000000001e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 3e-05 * fSlow15 + 0.0010012);
