...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxBuzz -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
...
static double GxBuzz_faustpower3_f(double value) {
	return value * value * value;
}

class GxBuzz : public chdsp {
 ...
 public:
	...
	GxBuzz(const GxBuzz&) = default;
	
	virtual ~GxBuzz() = default;
	
	GxBuzz& operator=(const GxBuzz&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxBuzz -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("description", "Buzz Box");
		m->declare("filename", "gx-buzz.dsp");
		...
		m->declare("name", "Buzz Box");
		m->declare("platform.lib/name", "Generic Platform Library");
		m->declare("platform.lib/version", "1.3.0");
		m->declare("shortname", "Buzz Box");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst7 = 1.0 / fConst6;
		fConst8 = GxBuzz_faustpower3_f(fConst0) / fConst6;
	}
	...
	virtual GxBuzz* clone() {
		return new GxBuzz(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Buzz Box");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = faust_wrap_add(i0, 1)) {
			...
			output0[i0] = static_cast<FAUSTFLOAT>(fSlow2 * fTemp0 + fConst8 * fRec1[0] * (3.81347663375185e-13 * fRec0[0] - 1.14404299012556e-12 * fRec0[1] + 1.14404299012556e-12 * fRec0[2] - 3.81347663375185e-13 * fRec0[3]));
