...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn LibKorg35Lpf -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __LibKorg35Lpf_H__
#define  __LibKorg35Lpf_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS LibKorg35Lpf
#endif
...
class LibKorg35Lpf : public chdsp {
 ...
 public:
	...
	LibKorg35Lpf(const LibKorg35Lpf&) = default;
	
	virtual ~LibKorg35Lpf() = default;
	
	LibKorg35Lpf& operator=(const LibKorg35Lpf&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn LibKorg35Lpf -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("description", "MS-20 style Korg35 2-pole lowpass with screaming self-oscillating resonance");
		m->declare("family", "filter");
		m->declare("filename", "lib-korg35-lpf.dsp");
		...
		m->declare("name", "Korg 35 LPF");
		m->declare("platform.lib/name", "Generic Platform Library");
		m->declare("platform.lib/version", "1.3.0");
		m->declare("signals.lib/name", "Faust Routing Library");
		m->declare("signals.lib/version", "1.7.0");
		m->declare("source", "grame-cncm/faustlibraries/vaeffects.lib ve.korg35LPF");
		m->declare("vaeffects.lib/korg35LPF:author", "Eric Tarr");
		m->declare("vaeffects.lib/korg35LPF:license", "LicenseRef-STK-4.3");
	...
	virtual LibKorg35Lpf* clone() {
		return new LibKorg35Lpf(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Korg 35 LPF");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = faust_wrap_add(i0, 1)) {
			...
			float fTemp4 = (static_cast<float>(input0[i0]) * fRec7[0] - fRec3[1]) * fTemp0;
			float fTemp5 = fTemp0 * ((fRec3[1] + (fTemp4 + 0.21521823f * fRec1[1] * fTemp3 * fTemp2 - fRec2[1]) / fTemp1) / (1.0f - 0.21521823f * (fTemp0 * fTemp3 * fTemp2 / fTemp1)) - fRec1[1]) / fTemp1;
			fRec1[0] = fRec1[1] + 2.0f * fTemp5;
			float fTemp6 = fRec1[1] + fTemp5;
			fRec2[0] = fRec2[1] + 2.0f * (fTemp0 * (0.21521823f * fTemp3 * fTemp6 - fRec2[1]) / fTemp1);
			fRec3[0] = fRec3[1] + 2.0f * (fTemp4 / fTemp1);
			float fRec4 = fTemp6;
