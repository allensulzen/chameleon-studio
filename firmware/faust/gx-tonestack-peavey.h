...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackPeavey -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackPeavey_H__
#define  __GxTonestackPeavey_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackPeavey
#endif
...
static double GxTonestackPeavey_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackPeavey_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackPeavey : public chdsp {
 ...
 public:
	...
	GxTonestackPeavey(const GxTonestackPeavey&) = default;
	
	virtual ~GxTonestackPeavey() = default;
	
	GxTonestackPeavey& operator=(const GxTonestackPeavey&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackPeavey -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-peavey.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackPeavey_faustpower2_f(fConst0);
		fConst2 = GxTonestackPeavey_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackPeavey* clone() {
		return new GxTonestackPeavey(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = 1.95976e-07 * fSlow1;
		double fSlow3 = fConst1 * (fSlow1 * (2.4497000000000004e-06 * fSlow0 + -4.3256399999999996e-07 - fSlow2) + 8.801210000000002e-06 * fSlow0 + 9.060568000000001e-07);
		double fSlow4 = 5.553900000000002e-10 * fSlow0;
		double fSlow5 = 2.0778120000000008e-10 * fSlow0 - 1.6622496000000003e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -2.7808704000000013e-11) + fSlow4 + 4.4431200000000016e-11);
		double fSlow7 = 0.0055675 * fSlow0;
		double fSlow8 = 0.00044 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.0035049);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 1.6622496000000003e-11) + fSlow15 * (fSlow4 + 4.4431200000000016e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (2.0196000000000004e-07 * fSlow15 + fSlow1 * (2.2567600000000002e-07 - fSlow2) + fSlow0 * (2.4497000000000004e-06 * fSlow1 + 5.732100000000001e-07) + 4.585680000000001e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 6.75e-05 * fSlow15 + 0.00044540000000000004);
