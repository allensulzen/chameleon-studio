...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackGroove -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackGroove_H__
#define  __GxTonestackGroove_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackGroove
#endif
...
static double GxTonestackGroove_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackGroove_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackGroove : public chdsp {
 ...
 public:
	...
	GxTonestackGroove(const GxTonestackGroove&) = default;
	
	virtual ~GxTonestackGroove() = default;
	
	GxTonestackGroove& operator=(const GxTonestackGroove&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackGroove -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-groove.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackGroove_faustpower2_f(fConst0);
		fConst2 = GxTonestackGroove_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackGroove* clone() {
		return new GxTonestackGroove(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Trio Preamp");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow16 = fSlow1 * (fSlow5 + 3.1708892160000014e-11) + fSlow15 * (fSlow4 + 7.486821760000003e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (3.0937280000000007e-07 * fSlow15 + fSlow1 * (2.893061600000001e-07 - fSlow2) + fSlow0 * (1.0875480000000001e-05 * fSlow1 + 3.6810400000000007e-06) + 8.098288000000002e-08);
