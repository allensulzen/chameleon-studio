...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxVoxwah -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxVoxwah_H__
#define  __GxVoxwah_H__
...
static double GxVoxwah_faustpower2_f(double value) {
	return value * value;
}
static double GxVoxwah_faustpower3_f(double value) {
	return value * value * value;
}

class GxVoxwah : public chdsp {
 ...
 public:
	...
	GxVoxwah(const GxVoxwah&) = default;
	
	virtual ~GxVoxwah() = default;
	
	GxVoxwah& operator=(const GxVoxwah&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxVoxwah -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("description", "Vox Wah V847");
		m->declare("filename", "gx-voxwah.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst22 = 1.77461540007175e-19 * fConst0;
		fConst23 = GxVoxwah_faustpower3_f(fConst0);
		fConst24 = fConst23 * (fConst22 + -1.27350423451651e-17);
		fConst25 = 1.18574819071565e-18 * fConst0;
		fConst26 = fConst0 * (fConst7 * (4.4130909394522e-17 - fConst25) + -3.9233605261862e-12);
		fConst27 = 2.00257188011043e-19 * fConst0;
	...
	virtual GxVoxwah* clone() {
		return new GxVoxwah(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Vox Wah V847");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow4 = 0.007000000000000006 * std::max<double>(0.03, static_cast<double>(fVslider2));
