...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackFenderBlues -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackFenderBlues_H__
#define  __GxTonestackFenderBlues_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackFenderBlues
#endif
...
static double GxTonestackFenderBlues_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackFenderBlues_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackFenderBlues : public chdsp {
 ...
 public:
	GxTonestackFenderBlues() {
	}
	
	GxTonestackFenderBlues(const GxTonestackFenderBlues&) = default;
	
	virtual ~GxTonestackFenderBlues() = default;
	
	GxTonestackFenderBlues& operator=(const GxTonestackFenderBlues&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackFenderBlues -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-fender-blues.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackFenderBlues_faustpower2_f(fConst0);
		fConst2 = GxTonestackFenderBlues_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackFenderBlues* clone() {
		return new GxTonestackFenderBlues(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Junior");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow3 = fConst1 * (fSlow1 * (3.0593750000000007e-06 * fSlow0 + -8.696875000000003e-07 - fSlow2) + 1.2718750000000003e-05 * fSlow0 + 1.5468750000000003e-06);
		double fSlow4 = 7.5625e-10 * fSlow0;
		double fSlow5 = 2.646875e-10 * fSlow0 - 2.6468750000000002e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -4.915625000000001e-11) + fSlow4 + 7.562500000000001e-11);
		double fSlow7 = 0.005562500000000001 * fSlow0;
		double fSlow8 = 0.00055 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.005018750000000001);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 2.6468750000000002e-11) + fSlow15 * (fSlow4 + 7.562500000000001e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (2.75e-07 * fSlow15 + fSlow1 * (3.403125000000001e-07 - fSlow2) + fSlow0 * (3.0593750000000007e-06 * fSlow1 + 6.1875e-07) + 6.1875e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 6.25e-05 * fSlow15 + 0.00055625);
