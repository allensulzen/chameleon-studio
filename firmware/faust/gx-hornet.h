...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxHornet -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxHornet_H__
#define  __GxHornet_H__
...
static double GxHornet_faustpower3_f(double value) {
	return value * value * value;
}
static double GxHornet_faustpower2_f(double value) {
	return value * value;
}
static double GxHornet_faustpower4_f(double value) {
	return value * value * value * value;
}

class GxHornet : public chdsp {
 ...
 public:
	...
	GxHornet(const GxHornet&) = default;
	
	virtual ~GxHornet() = default;
	
	GxHornet& operator=(const GxHornet&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxHornet -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("description", "Hornet simulation");
		m->declare("filename", "gx-hornet.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst13 = 2.89798007739403e-18 * fConst0;
		fConst14 = fConst13 + -1.51064918927987e-14;
		fConst15 = 2.28655633153439e-18 * fConst0;
		fConst16 = fConst15 + -1.19192830048069e-14;
		fConst17 = GxHornet_faustpower3_f(fConst0);
		fConst18 = 1.45891323583538e-19 * fConst0;
		fConst19 = GxHornet_faustpower2_f(fConst0);
		...
		fConst25 = 2.4218162356217e-20 * fConst0;
		...
		fConst57 = 1.15919203095761e-17 * fConst0;
		fConst58 = 3.02129837855973e-14 - fConst57;
		fConst59 = 9.14622532613756e-18 * fConst0;
		fConst60 = 2.38385660096139e-14 - fConst59;
		fConst61 = 5.83565294334152e-19 * fConst0;
		fConst62 = 1.4809789263016e-15 - fConst61;
		fConst63 = 1.34732474860735e-19 * fConst0;
		fConst64 = fConst63 + -3.51164429158298e-16;
		fConst65 = 3.78598254358668e-20 * fConst0;
		fConst66 = 9.86772045934826e-17 - fConst65;
		fConst67 = 9.6872649424868e-20 * fConst0;
		fConst68 = 2.53719166715271e-16 - fConst67;
		fConst69 = GxHornet_faustpower4_f(fConst0);
	...
	virtual GxHornet* clone() {
		return new GxHornet(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Hornet");
