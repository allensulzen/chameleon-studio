...
Compilation options: -lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackJtm45 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __GxTonestackJtm45_H__
#define  __GxTonestackJtm45_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS GxTonestackJtm45
#endif
...
static double GxTonestackJtm45_faustpower2_f(double value) {
	return value * value;
}
static double GxTonestackJtm45_faustpower3_f(double value) {
	return value * value * value;
}

class GxTonestackJtm45 : public chdsp {
 ...
 public:
	...
	GxTonestackJtm45(const GxTonestackJtm45&) = default;
	
	virtual ~GxTonestackJtm45() = default;
	
	GxTonestackJtm45& operator=(const GxTonestackJtm45&) = default;
	
	void metadata(Meta* m) { 
		m->declare("chameleon_flags", "-double");
		m->declare("compile_options", "-lang cpp -i -fpga-mem-th 4 -ct 1 -cn GxTonestackJtm45 -scn chdsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "gx-tonestack-jtm45.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = GxTonestackJtm45_faustpower2_f(fConst0);
		fConst2 = GxTonestackJtm45_faustpower3_f(fConst0);
		fConst3 = 3.0 * fConst2;
	}
	...
	virtual GxTonestackJtm45* clone() {
		return new GxTonestackJtm45(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("JTM-45");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = 3.0621250000000006e-07 * fSlow1;
		double fSlow3 = fConst1 * (fSlow1 * (1.2248500000000003e-05 * fSlow0 + -5.596250000000005e-08 - fSlow2) + 1.784904e-05 * fSlow0 + 5.442360000000002e-07);
		double fSlow4 = 1.0781100000000005e-09 * fSlow0;
		double fSlow5 = 9.245610000000004e-10 * fSlow0 - 2.3114025000000008e-11 * fSlow1;
		double fSlow6 = fConst2 * (fSlow1 * (fSlow5 + -3.8387250000000005e-12) + fSlow4 + 2.695275000000001e-11);
		double fSlow7 = 0.02227 * fSlow0;
		double fSlow8 = 0.00055 * fSlow1;
		double fSlow9 = fConst0 * (fSlow8 + fSlow7 + 0.00207625);
		...
		double fSlow16 = fSlow1 * (fSlow5 + 2.3114025000000008e-11) + fSlow15 * (fSlow4 + 2.695275000000001e-11 * (1.0 - fSlow1));
		double fSlow17 = fConst2 * fSlow16;
		double fSlow18 = fConst1 * (9.801000000000002e-08 * fSlow15 + fSlow1 * (3.433375000000001e-07 - fSlow2) + fSlow0 * (1.2248500000000003e-05 * fSlow1 + 1.8770400000000002e-06) + 4.6926e-08);
		double fSlow19 = fConst0 * (fSlow7 + fSlow8 + 6.75e-05 * fSlow15 + 0.0005567500000000001);
